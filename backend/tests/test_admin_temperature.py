...
def test_temperature_returns_cpu_and_gpu(client):
    ...
    with patch("app.api.admin._get_temp_monitor", return_value=mock_monitor):
...
def test_temperature_returns_none_when_unavailable(client):
